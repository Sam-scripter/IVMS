...
class FuelOrderReportService {
  Future<Uint8List> generateFuelOrdersReport() async {
    final pdf = pw.Document();
    final today = DateTime.now();
    final fuelOrders = await _fetchFuelOrders();
  ...
  Future<List<Map<String, dynamic>>> _fetchFuelOrders() async {
    List<Map<String, dynamic>> fuelOrders = [];

    QuerySnapshot querySnapshot =
        await FirebaseFirestore.instance.collection('Fuel Orders').get();
