...
class FuelShipmentReportService {
  Future<Uint8List> generateFuelShipmentReport() async {
    final pdf = pw.Document();
    final today = DateTime.now();
    final fuelShipments = await _fetchFuelShipments();
        ...
        build: (pw.Context context) {
          return [
            ...
            pw.Table.fromTextArray(
              ...
              data: fuelShipments.map((shipment) {
                return [
  ...
  Future<List<Map<String, dynamic>>> _fetchFuelShipments() async {
    List<Map<String, dynamic>> fuelShipments = [];

    QuerySnapshot querySnapshot =
        await FirebaseFirestore.instance.collection('Fuel Shipments').get();
    ...
    for (var document in querySnapshot.docs) {
      ...
      fuelShipments.add(shipmentInfo);
    }

    return fuelShipments;
  }
